...
* COSC 1337 001 
* 10/04/2021 
* Purpose: Program will verify that the credit card number is valid using the Luhn Algorithm. 
* User will be prompted to enter their card number until a valid number is entered.  
* A PIN will be issued only if the card is valid.(Program 02)
*/
...
public class Program2CCValidation {
    public static void main(String[] args) {
        ...
        int low = 1111;
        int high = 9999;
        int randomPin = random.nextInt(high-low +1) + low;
